...
namespace printer
{
	...
	void print_states(const char *filename, dmod::array1d &background, dmod::array1d &amplitude, dmod::array1d &frequency, dmod::array1d &phase);
	...
	void print_Kalman_stdev(const char *filename, std::vector<Eigen::Vector4d> &states, dmod::array1d &signal, dmod::array1d &noise,
